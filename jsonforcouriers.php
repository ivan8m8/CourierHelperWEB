<?php
	...
	/**
	* Для того, чтобы доставки, хранящиеся на Вашем сервере, скопировать в формат JSON,
	* необходимо указать данные от Вашей MySQL-базы данных.
	* Как Вы можете видеть, эти данные нужны данному скрипту
	* только для того, чтобы прочитать их.
	* Данные о Ваших доставках будут доступны только на этой странице.
	*/

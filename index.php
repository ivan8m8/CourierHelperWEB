...
$mysql_courierstablename = ""; // название MySQL-таблицы, в кторой харнится информация о курьерах
...
$query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryStatus = "0" ORDER BY deliveryTimeLimit DESC';
...
if (isset($_POST["sort_by_districts"]))  {
    ...
    *******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "ЦАО";' or die("Не удалось загрузить доставки по ЦАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    ******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "ЗАО";' or die("Не удалось загрузить доставки по ЗАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    *******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "СЗАО";' or die("Не удалось загрузить доставки по СЗАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    ******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "САО";' or die("Не удалось загрузить доставки по САО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    ******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "СВАО";' or die("Не удалось загрузить доставки по СВАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    ******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "ВАО";' or die("Не удалось загрузить доставки по ВАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    ******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "ЮВАО";' or die("Не удалось загрузить доставки по ЮВАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    ******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "ЮАО";' or die("Не удалось загрузить доставки по ЮАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
    ...
    ******/
    ...
    $query = 'SELECT * FROM `$mysql_tablename` WHERE deliveryDistrict = "ЮЗАО";' or die("Не удалось загрузить доставки по ЮЗАО");
    $result = mysql_query($query) or die('Запрос не удался: ' . mysql_error());
    $query2 = 'SELECT * FROM $mysql_courierstablename' or die('Не удалось загрузить курьеров' . mysql_error());
...
if (isset($_POST["send_to_couriers"])) {
    ...
    foreach ($_REQUEST["choose_courier"] as $key => $value) {
        mysql_query("UPDATE $mysql_tablename SET deliveryCourier = '".mysql_real_escape_string($value)."' WHERE orderNumber = '".mysql_real_escape_string($key)."';") or die('Не удалось записать курьеров: ' . mysql_error());
    }
    mysql_close($link);
